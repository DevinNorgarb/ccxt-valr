...
class valr extends valr$1 {
    ...
    parseWsBalance(balanceWs) {
        ...
        const debt = Precise["default"].stringAdd(this.safeString(balanceWs, 'lendReserved'), this.safeString(balanceWs, 'borrowReserved'));
        if (code !== undefined) {
            result[code] = {
    ...
    parseWsOrder(order, market = undefined) {
        ...
        if (remaining === undefined && filledPercentage !== undefined) {
            filled = Precise["default"].stringMul(amount, filledPercentage);
        }
