...
import { NotSupported, ArgumentsRequired, InvalidOrder, BadSymbol, NullResponse, BadRequest, } from './base/errors.js';
// ---------------------------------------------------------------------------
/**
 * @class valr
 * @augments Exchange
...
export default class valr extends Exchange {
    ...
    parseBalance(balances) {
        ...
        for (let i = 0; i < balances.length; i++) {
            ...
            const debt = Precise.stringAdd(this.safeString(balance, 'lendReserved'), this.safeString(balance, 'borrowReserved'));
            result[code] = {
