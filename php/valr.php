...
class valr extends Exchange {
    ...
    public function fetch_ticker(string $symbol, $params = array ()): array {
        ...
        $response = $this->publicGetPairMarketsummary (array_merge($request, $params));
    ...
    public function fetch_order_book(string $symbol, ?int $limit = null, $params = array ()): array {
        ...
        if ($this->check_required_credentials(false)) {
            $response = $this->privateGetMarketdataPairOrderbook ($params);
        } else {
            $response = $this->publicGetPairOrderbook ($params);
        }
    ...
    public function fetch_l3_order_book(string $symbol, ?int $limit = null, $params = array ()): array {
        ...
        $params['pair'] = $this->market_id($symbol);
        if ($this->check_required_credentials(false)) {
            $response = $this->privateGetMarketdataPairOrderbookFull ($params);
        } else {
            $response = $this->publicGetPairOrderbookFull ($params);
        }
        $lastDateChange = $this->safe_string($response, 'LastChange');
        $timestamp = $this->parse8601($lastDateChange);
    ...
    public function fetch_accounts($params = array ()): array {
         ...
         */
        $response = $this->privateGetAccountSubaccounts ($params);
    ...
    public function fetch_order(string $id, ?string $symbol = null, $params = array ()): array {
        ...
        $response = $this->privateGetOrdersPairOrderidId (array_merge($request, $params));
        // {
    ...
    public function fetch_closed_orders(?string $symbol = null, ?int $since = null, ?int $limit = null, $params = array ()): array {
         ...
         */
        $this->load_markets();
        $response = $this->privateGetOrdersHistory ($params);
        // [array('orderId' => 'aa6dce9a-6acb-477f-9da8-223127e6b32d',
    ...
    public function create_order(string $symbol, string $type, string $side, float $amount, ?float $price = null, $params = array ()): array {
        ...
        if ($type === 'market') {
            ...
            $response = $this->privatePostOrdersMarket (array_merge($body, $params));
        } elseif ($type === 'limit') {
            ...
            $response = $this->privatePostOrdersLimit (array_merge($body, $params));
        } else {
    ...
    public function edit_order(string $id, string $symbol, string $type, string $side, ?float $amount = null, ?float $price = null, $params = array ()): array {
        ...
        // $this->privatePutOrdersModify ($this->entend (body, $params));
    }
    ...
    public function cancel_order(string $id, ?string $symbol = null, $params = array ()): array {
        ...
        $this->privateDeleteOrdersOrder (array_merge($orderFormat, $params));
    ...
    public function cancel_all_orders(?string $symbol = null, $params = array ()): array {
        ...
        if ($symbol === null) {
            ...
            $response = $this->privateDeleteOrdersPair (array_merge($body, $params));
    ...
    public function fetch_trades(string $symbol, ?int $since = null, ?int $limit = null, $params = array ()): array {
        ...
        $params['pair'] = $this->market_id($symbol);
        if ($this->check_required_credentials(false)) {
            $response = $this->privateGetMarketdataPairTradehistory ($params);
            // array(
            //     array(
            //       "price" => "43023",
            //       "quantity" => "0.01971316",
    ...
    public function fetch_my_trades(?string $symbol = null, ?int $since = null, ?int $limit = null, $params = array ()): array {
        ...
        $params['pair'] = $this->market_id($symbol);
        $response = $this->privateGetAccountPairTradehistory ($params);
        // array(
        //     array(
        //       "price" => "29001",
        //       "quantity" => "0.00137926",
    ...
    public function fetch_deposit_address(string $code, $params = array ()) {
        ...
        if ($this->is_fiat($code)) {
            $response = $this->privateGetWalletFiatCurrencyDepositReference (array_merge($currencyId, $params));
            // array('reference' => 'USDGVVU6XR')
        } else {
            $response = $this->privateGetWalletCryptoCurrencyDepositAddress (array_merge($currencyId, $params));
            // {'currency' => 'BTC',
    ...
    public function fetch_deposits(?string $code = null, ?int $since = null, ?int $limit = null, $params = array ()): array {
        ...
        $response = $this->privateGetWalletCryptoCurrencyDepositHistory (array_merge($currencyId, $params));
        // array(
        //     array(
        //       "currencyCode" => "BTC",
    ...
    public function fetch_withdrawals(?string $code = null, ?int $since = null, ?int $limit = null, $params = array ()): array {
        ...
        $response = $this->privateGetWalletCryptoCurrencyWithdrawHistory (array_merge($currency, $params));
        // array(
        //     array(
        //       "currency" => "BTC",
    ...
    public function withdraw(string $code, float $amount, string $address, $tag = null, $params = array ()): array {
        ...
        if ($this->is_fiat($code)) {
            ...
            $response = $this->privatePostWalletFiatCurrencyWithdraw (array_merge($withdrawalBody, $params));
        } else {
            $withdrawalBody = array(
                'currency' => $currency['id'],
                'address' => $address,
            ...
            $response = $this->privatePostWalletCryptoCurrencyWithdraw (array_merge($withdrawalBody, $params));
        }
