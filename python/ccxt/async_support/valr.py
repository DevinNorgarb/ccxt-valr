...
class valr(Exchange, ImplicitAPI):
    ...
    async def fetch_order_book(self, symbol: str, limit: Int = None, params={}) -> OrderBook:
        ...
        if self.check_required_credentials(False):
            response = await self.privateGetMarketdataPairOrderbook(params)
        else:
            response = await self.publicGetPairOrderbook(params)
    ...
    async def fetch_l3_order_book(self, symbol: str, limit: Int = None, params={}) -> OrderBook:
        ...
        params['pair'] = self.market_id(symbol)
        if self.check_required_credentials(False):
            response = await self.privateGetMarketdataPairOrderbookFull(params)
        else:
            response = await self.publicGetPairOrderbookFull(params)
        lastDateChange = self.safe_string(response, 'LastChange')
        timestamp = self.parse8601(lastDateChange)
    ...
    async def fetch_accounts(self, params={}) -> List[Account]:
        ...
        """
        response = await self.privateGetAccountSubaccounts(params)
    ...
    async def fetch_closed_orders(self, symbol: str = None, since: Int = None, limit: Int = None, params={}) -> List[Order]:
        ...
        """
        await self.load_markets()
        response = await self.privateGetOrdersHistory(params)
        # [{'orderId': 'aa6dce9a-6acb-477f-9da8-223127e6b32d',
    ...
    async def edit_order(self, id: str, symbol: str, type: OrderType, side: OrderSide, amount: float = None, price: float = None, params={}) -> Order:
        ...
        # await self.privatePutOrdersModify(self.entend(body, params))
    ...
    async def fetch_trades(self, symbol: str, since: Int = None, limit: Int = None, params={}) -> List[Trade]:
        ...
        params['pair'] = self.market_id(symbol)
        if self.check_required_credentials(False):
            response = await self.privateGetMarketdataPairTradehistory(params)
            # [
            #     {
            #       "price": "43023",
            #       "quantity": "0.01971316",
    ...
    async def fetch_my_trades(self, symbol: str = None, since: Int = None, limit: Int = None, params={}) -> List[Trade]:
        ...
        params['pair'] = self.market_id(symbol)
        response = await self.privateGetAccountPairTradehistory(params)
        # [
        #     {
        #       "price": "29001",
        #       "quantity": "0.00137926",
    ...
    async def fetch_deposits(self, code: str = None, since: Int = None, limit: Int = None, params={}) -> List[Transaction]:
        ...
        response = await self.privateGetWalletCryptoCurrencyDepositHistory(self.extend(currencyId, params))
        # [
        #     {
        #       "currencyCode": "BTC",
    ...
    async def fetch_withdrawals(self, code: str = None, since: Int = None, limit: Int = None, params={}) -> List[Transaction]:
        ...
        response = await self.privateGetWalletCryptoCurrencyWithdrawHistory(self.extend(currency, params))
        # [
        #     {
        #       "currency": "BTC",
